...
export default function OrderShow({ order }) {
    ...
    const address = order.shipping_address && typeof order.shipping_address === 'object'
        ...
        : { full_name: 'N/A', address: order.shipping_address };
        ...
        <MainLayout>
            ...
            <div className="max-w-6xl mx-auto py-12 px-6 sm:px-8">
                <nav className="mb-8 flex items-center space-x-2 text-sm text-gray-400">
                    <button onClick={() => router.visit('/orders')} className="flex items-center gap-1 hover:text-white transition-colors p-2 -m-2 rounded-lg">
                        <ArrowLeft size={16} />
                        Orders
                    </button>
                    ...
                    <div className="bg-gray-900/30 border border-gray-700/50 backdrop-blur-xl rounded-2xl p-8">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="bg-gray-800/50 p-6 rounded-xl">
                                ...
                                <p className="text-gray-300">{address.city}, {address.province || address.state} {address.postal_code || address.zip}</p>
                            ...
                            <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-amber-200">Your order is being processed. We will notify you when it ships.</p>
                                    </div>
                                </div>
                            </div>
                        )}
