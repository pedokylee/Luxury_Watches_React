...
export default function Create({ categories = [], brands = [] }) {
    ...
    const fields = [
        { key: 'name', label: 'Product Name', placeholder: 'e.g. Submariner Date 41mm', type: 'text', full: true },
        { key: 'price', label: 'Price (USD)', placeholder: '0.00', type: 'number' },
    ...
    return (
        <AdminLayout title="Add Product">
            <div style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <span style={{ fontSize: '0.75rem', color: 'white' }}>Add Product</span>
            </div>

            <div style={{ marginBottom: '1.5rem' }}>
                <p className="section-label" style={{ marginBottom: '0.35rem' }}>New Item</p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '1.5rem', alignItems: 'start' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <div style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', padding: '1.5rem' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                ...
                                <div style={{ gridColumn: 'span 2' }}>
                                    ...
                                    <input type="text" placeholder="e.g. Submariner Date 41mm"
                        ...
                        <div style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', padding: '1.5rem' }}>
                            ...
                            <textarea
                                placeholder="Describe the watch — materials, movement, features..."
                        ...
                        <div style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', padding: '1.5rem' }}>
                            ...
                            <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                                ...
                                <div onClick={() => setData('is_active', !data.is_active)}
                                     style={{ width: 44, height: 24, borderRadius: 12, cursor: 'pointer', transition: 'background-color 0.2s',
                                              backgroundColor: data.is_active ? 'var(--color-accent)' : 'var(--color-border)',
                                              position: 'relative' }}>
                                    <div style={{ position: 'absolute', top: 2, transition: 'left 0.2s', width: 20, height: 20,
