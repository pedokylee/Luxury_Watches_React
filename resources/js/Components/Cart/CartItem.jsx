    ...
    return (
        <div style={{ backgroundColor: 'var(--color-surface)', padding: '1.5rem',
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ color: 'white', fontWeight: 600, fontSize: '0.95rem', marginBottom: '0.4rem',
            ...
            <div style={{ display: 'flex', alignItems: 'center', border: '1px solid var(--color-border)' }}>
                <button onClick={() => updateQty(item.quantity - 1)}
                        disabled={item.quantity <= 1}
                        style={{ width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center',
                                 color: 'var(--color-muted)', borderRight: '1px solid var(--color-border)',
                ...
                <button onClick={() => updateQty(item.quantity + 1)}
                        style={{ width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center',
                                 color: 'var(--color-muted)', borderLeft: '1px solid var(--color-border)',
